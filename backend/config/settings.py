...
MAX_IMAGE_SIZE = config('MAX_IMAGE_SIZE', default=5, cast=int) * 1024 * 1024
MAX_REPORT_SIZE = config('MAX_REPORT_SIZE', default=10, cast=int) * 1024 * 1024
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@dmu.edu.et')
...
SLA_WARNING_THRESHOLD = 0.8  # Alert at 80% of time
